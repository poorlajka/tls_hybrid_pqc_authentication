...
extern int SDITH_randombytes(unsigned char* x, unsigned long long xlen);
#define sample_seed(seed) SDITH_randombytes(seed, PARAM_SEED_SIZE)
#define sample_salt(seed) SDITH_randombytes(seed, PARAM_SALT_SIZE)
