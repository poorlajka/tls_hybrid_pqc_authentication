...
// primary parameters
#define PARAM_q 251   // cardinal of F_poly
#if (PARAM_fpoint_size == 3)
#define fpoints_mul_ct p251p3_mul_ct
#define fpoints_mul p251p3_mul
#define fpoints_add p251p3_add
#define fpoints_sub p251p3_sub
#define fpoints_pow p251p3_pow
#define fpoints_dlog p251p3_dlog
#define fpoints_dexp p251p3_dexp
#define fpoints_dlog_pow_log p251p3_dlog_pow_l32
#define fpoints_dlog_mul_log_log p251p3_dlog_mul_l32_l32
#define PAR_fpoints_order SDITH_ORDER_P251P3
#elif (PARAM_fpoint_size == 4)
#define fpoints_mul_ct p251p4_mul_ct
#define fpoints_mul p251p4_mul
#define fpoints_add p251p4_add_naive
#define fpoints_sub p251p4_sub_naive
#define fpoints_pow p251p4_pow
#define fpoints_dlog p251p4_dlog
#define fpoints_dexp p251p4_dexp
#define fpoints_dlog_pow_log p251p4_dlog_pow_l32
#define fpoints_dlog_mul_log_log p251p4_dlog_mul_l32_l32
#define PAR_fpoints_order SDITH_ORDER_P251P4
#else
