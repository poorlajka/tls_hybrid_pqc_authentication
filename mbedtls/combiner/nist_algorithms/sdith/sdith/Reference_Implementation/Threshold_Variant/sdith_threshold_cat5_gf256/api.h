...
#define CRYPTO_ALGNAME "sdith_threshold_cat5_gf256"
...
* Returns 0 (success)
**************************************************/
int SDITH_crypto_sign(unsigned char* sm, unsigned long long* smlen, const unsigned char* m,
                unsigned long long mlen, const unsigned char* sk);
...
**************************************************/
int crypto_sign_SDITH_verify(const unsigned char *sig, unsigned long long siglen, const unsigned char *m,
...
**************************************************/
int SDITH_crypto_sign_open(unsigned char* m, unsigned long long* mlen, const unsigned char* sm,
