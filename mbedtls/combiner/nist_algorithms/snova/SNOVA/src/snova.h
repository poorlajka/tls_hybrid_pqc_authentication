...
void SNOVA_shake256(const uint8_t* pt_seed_array, int input_bytes, uint8_t* pt_output_array,
              int output_bytes);

void snova_init(void);

void SNOVA_generate_keys_ssk(uint8_t* pk, uint8_t* ssk,
                       const uint8_t* pkseed, const uint8_t* skseed);
void SNOVA_generate_keys_esk(uint8_t* pk, uint8_t* esk,
                       const uint8_t* pkseed, const uint8_t* skseed);

void SNOVA_generate_pk_with_ssk(uint8_t* pk, const uint8_t* ssk);
void SNOVA_generate_pk_with_esk(uint8_t* pk, const uint8_t* esk);

void SNOVA_sign_digest_ssk(uint8_t* pt_signature, const uint8_t* digest,
                     uint64_t bytes_digest, uint8_t* array_salt,
                     const uint8_t* ssk);
void SNOVA_sign_digest_esk(uint8_t* pt_signature, const uint8_t* digest,
                     uint64_t bytes_digest, uint8_t* array_salt,
                     const uint8_t* esk);

void SNOVA_expand_public_pack(uint8_t* pkx_pck, const uint8_t *pk);

int SNOVA_verify_signture(const uint8_t* pt_digest, uint64_t bytes_digest,
                    const uint8_t* pt_signature, const uint8_t* pk);
int SNOVA_verify_signture_pkx(const uint8_t* pt_digest, uint64_t bytes_digest,
                            const uint8_t* pt_signature, const uint8_t* pk);
