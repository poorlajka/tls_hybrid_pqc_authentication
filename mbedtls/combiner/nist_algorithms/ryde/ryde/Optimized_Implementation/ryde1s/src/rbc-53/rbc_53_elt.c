...
void rbc_53_elt_ur_sqr(rbc_53_elt_ur o, const rbc_53_elt e) {
  ...
  e_l = _mm_and_si128(tmp, RBC_53_ELT_SQR_MASK_128);
  e_h = _mm_and_si128(_mm_srli_epi64(tmp, 4), RBC_53_ELT_SQR_MASK_128);

  e_l = _mm_shuffle_epi8(RBC_53_ELT_SQR_LOOKUP_TABLE_128, e_l);
  e_h = _mm_shuffle_epi8(RBC_53_ELT_SQR_LOOKUP_TABLE_128, e_h);
