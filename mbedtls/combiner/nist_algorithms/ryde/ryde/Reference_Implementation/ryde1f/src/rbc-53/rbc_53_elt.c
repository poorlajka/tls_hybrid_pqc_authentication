/**
 * \file rbc_53_elt.c
 * \brief Implementation of rbc_53_elt.h
 */

#include "rbc_53.h"
#include "rbc_53_elt.h"

static uint8_t rbc_53_init_field = 0;
uint64_t RBC_53_SQR_LOOKUP_TABLE[256];



/**
 * \fn void rbc_53_field_init(void)
...
void rbc_53_field_init(void) {
  ...
  if(rbc_53_init_field == 0) {
    memset(RBC_53_SQR_LOOKUP_TABLE, 0, 8 * 256);
    for(size_t i = 0 ; i < 256 ; ++i) {
      for(size_t j = 0 ; j < 8 ; ++j) {
        mask = 1 << j;
        bit = (mask & i) >> j;
        RBC_53_SQR_LOOKUP_TABLE[i] ^= bit << (2 * j);
      }
    }
...
/**
 * \fn void rbc_53_elt_set_zero(rbc_53_elt o)
 * \brief This function sets a finite field element to zero.
 *
 * \param[out] o rbc_53_elt
 */
...
/**
 * \fn void rbc_53_elt_set_one(rbc_53_elt o)
...
/**
 * \fn void rbc_53_elt_set(rbc_53_elt o, const rbc_53_elt e)
 * \brief This function copies a finite field element into another one.
 *
 * \param[out] o rbc_53_elt
 * \param[in] e rbc_53_elt
 */
...
/**
* \fn void rbc_53_elt_set_mask1(rbc_53_elt o, const rbc_53_elt e1, const rbc_53_elt e2, uint32_t mask)
* \brief This function copies either e1 or e2 into o depending on the mask value
*
* \param[out] o rbc_53_elt
* \param[in] e1 rbc_53_elt
* \param[in] e2 rbc_53_elt_n* \param[in] mask 1 to copy e1 and 0 to copy e2
*/
void rbc_53_elt_set_mask1(rbc_53_elt o, const rbc_53_elt e1, const rbc_53_elt e2, uint32_t mask) {
  for(uint8_t i = 0 ; i < RBC_53_ELT_SIZE ; i++) {
    o[i] = mask * e1[i] + (1 - mask) * e2[i];
  }
}

/**
 * \fn void rbc_53_elt_set_from_uint64(rbc_53_elt o, uint64_t* rbc_53_elt e)
...
/**
 * \fn uint8_t rbc_53_elt_is_zero(const rbc_53_elt e)
...
/**
 * \fn uint8_t rbc_53_elt_is_equal_to(const rbc_53_elt e1, const rbc_53_elt e2)
 * \brief This function tests if two finite field elements are equal.
 *
 * \param[in] e1 rbc_53_elt
 * \param[in] e2 rbc_53_elt
...
/**
 * \fn int32_t rbc_53_elt_get_degree(const rbc_53_elt e)
...
/**
 * \fn uint8_t rbc_53_elt_get_coefficient(const rbc_53_elt e, uint32_t index)
...
/**
 * \fn void rbc_53_elt_set_coefficient_vartime(rbc_53_elt o, uint32_t index, uint64_t bit)
...
/**
 * \fn rbc_53_elt_add(rbc_53_elt o, const rbc_53_elt e1, const rbc_53_elt e2)
...
/**
 * \fn void rbc_53_elt_mul(rbc_53_elt o, const rbc_53_elt e1, const rbc_53_elt e2)
...
void rbc_53_elt_mul(rbc_53_elt o, const rbc_53_elt e1, const rbc_53_elt e2) {
  rbc_53_elt_ur tmp;
  rbc_53_elt_ur_mul(tmp, e1, e2);
  rbc_53_elt_reduce(o, tmp);
}



/**
 * \fn void rbc_53_elt_sqr(rbc_53_elt o, const rbc_53_elt e)
 * \brief This function computes the square of a finite field element.
 *
 * \param[out] o rbc_53_elt equal to \f$ e^{2} \f$
 * \param[in] e rbc_53_elt
 */
void rbc_53_elt_sqr(rbc_53_elt o, const rbc_53_elt e) {
  /*
  if(rbc_53_init_field == 0) {
    printf("Call to rbc_53_elt_sqr with uninitialized field\n");
    exit(1);
  }
  */

  rbc_53_elt_ur tmp;
  rbc_53_elt_ur_sqr(tmp, e);
  rbc_53_elt_reduce(o, tmp);
}

/**
 * \fn void rbc_53_elt_reduce(rbc_53_elt o, const rbc_53_elt_ur e)
 * \brief This function reduces a finite field element.
 *
 * \param[out] o rbc_53_elt equal to $ e \pmod f $
 * \param[in] e rbc_53_elt
 */
void rbc_53_elt_reduce(rbc_53_elt o, const rbc_53_elt_ur e) {
  uint64_t tmp = (e[1] << 11) ^ (e[0] >> 53) ^ (e[1] >> 36) ^ (e[1] >> 40);
  o[0] = e[0] ^ tmp ^ (tmp << 1) ^ (tmp << 2) ^ (tmp << 6);
  o[0] &= 0x001FFFFFFFFFFFFF;
}

/**
 * \fn void rbc_53_elt_print(const rbc_53_elt e)
...
/**
 * \fn void rbc_53_elt_ur_set(rbc_53_elt_ur o, const rbc_53_elt_ur e)
...
void rbc_53_elt_ur_set(rbc_53_elt_ur o, const rbc_53_elt_ur e) {
  for(uint8_t i = 0 ; i < RBC_53_ELT_UR_SIZE ; i++) {
    o[i] = e[i];
  }
}

/**
 * \fn void rbc_53_elt_ur_set_zero(rbc_53_elt_ur o)
 * \brief This function sets an unreduced finite field element to zero.
 *
 * \param[out] o rbc_53_elt_ur
 */
...
/**
 * \fn void rbc_53_elt_ur_mul(rbc_53_elt_ur o, const rbc_53_elt e1, const rbc_53_elt e2)
 * \brief This function computes the unreduced multiplication of two finite field elements.
 *
 * \param[out] o rbc_53_elt equal to \f$ e_1 \times e_2 $
 * \param[in] e1 rbc_53_elt
 * \param[in] e2 rbc_53_elt
 */
void rbc_53_elt_ur_mul(rbc_53_elt_ur o, const rbc_53_elt e1, const rbc_53_elt e2) {
  uint64_t shifts[64][RBC_53_ELT_SIZE + 1];
  rbc_53_elt_set(shifts[0], e2);
  shifts[0][RBC_53_ELT_SIZE] = 0;
  
  for(uint8_t shift=1 ; shift<64 ; shift++) {
    shifts[shift][0] = shifts[shift-1][0] << 1;
    for(uint8_t i=1 ; i<RBC_53_ELT_SIZE + 1 ; i++) {
      shifts[shift][i] = (shifts[shift-1][i] << 1) | (shifts[shift-1][i-1] >> 63);
    }
  }
  
  rbc_53_elt_ur_set_zero(o);
  for(uint8_t i=0 ; i<RBC_53_FIELD_M ; i++) {
    uint8_t shift = i % 64;
    uint8_t offset = i / 64;
    uint64_t multiplier = (e1[offset] >> shift) & 0x1;
    for(uint8_t j=0 ; j<RBC_53_ELT_SIZE + 1 ; j++) {
...
/**
 * \fn void rbc_53_elt_to_string(uint8_t* str, const rbc_53_elt e)
...
void rbc_53_elt_to_string(uint8_t* str, const rbc_53_elt e) {
  uint32_t bytes1 = RBC_53_FIELD_M / 8;
  uint32_t bytes2 = RBC_53_FIELD_M % 8;

  memset(str, 0, RBC_53_ELT_UINT8_SIZE);
  memcpy(str, e, bytes1);

  uint8_t k = 0;
  for(size_t j = 1 ; j <= bytes2 ; j++) {
    uint8_t bit = rbc_53_elt_get_coefficient(e, RBC_53_FIELD_M - j);
    *(str + bytes1) |= (bit << k % 8);
    k++;
    if(k % 8 == 0) bytes1++;
  }
