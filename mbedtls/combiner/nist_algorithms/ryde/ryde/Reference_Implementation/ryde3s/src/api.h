...
#ifndef RYDE_3S_API_H
#define RYDE_3S_API_H

#include "parameters.h"

#define CRYPTO_ALGNAME "RYDE-3S"

#define CRYPTO_PUBLICKEYBYTES RYDE_3S_PUBLIC_KEY_BYTES
#define CRYPTO_SECRETKEYBYTES RYDE_3S_SECRET_KEY_BYTES
#define CRYPTO_BYTES          RYDE_3S_SIGNATURE_BYTES
