...
namespace {
  ...
  void bench_sign_and_verify(unsigned int iter) {
    ...
    for (unsigned int i = 0; i != iter; ++i) {
      ...
      auto ret        = FAEST_crypto_sign_keypair(pk.data(), sk.data());
      ...
      ret         = FAEST_crypto_sign(sig.data(), &smlen, msg.data(), msg.size(), sk.data());
      ...
      start_time    = high_resolution_clock::now();
      ret           = FAEST_crypto_sign_open(msg1.data(), &msg1len, sig.data(), smlen, pk.data());
