 ...
 */
unsigned long long SPHINCS_crypto_sign_secretkeybytes(void)
{
 ...
 */
unsigned long long SPHINCS_crypto_sign_publickeybytes(void)
{
 ...
 */
unsigned long long SPHINCS_crypto_sign_bytes(void)
{
    return CRYPTO_BYTES;
}
 ...
 */
unsigned long long SPHINCS_crypto_sign_seedbytes(void)
{
...
int SPHINCS_crypto_sign_keypair(unsigned char *pk, unsigned char *sk)
{
  ...
  SPHINCS_randombytes(seed, CRYPTO_SEEDBYTES);
                          ...
                          const uint8_t *m, size_t mlen, const uint8_t *sk)
{
    ...
    SPHINCS_randombytes(optrand, SPX_N);
                ...
                const unsigned char *sk)
{
    ...
    SPHINCS_crypto_sign_signature(sm, &siglen, m, (size_t)mlen, sk);
