...
int
UOV_crypto_sign(unsigned char *sm, size_t *smlen,
...
int
UOV_crypto_sign_open(unsigned char *m, size_t *mlen,
...
int
UOV_crypto_sign(unsigned char *sm, unsigned long long *smlen,
...
int
UOV_crypto_sign_open(unsigned char *m, unsigned long long *mlen,
