...
//
// choose implementations for SHAKE256, AES128CTR, and UOV_randombytes() functions
//
...
//
// Options for UOV_randombytes()
//
//
// The following macro will implement UOV_randombytes() with utils/nistkat/rng.[hc]
// It uses AEC256CTR and AES256_ECB from openssl.
//
//#define _NIST_KAT_
//
// The following macro will implement UOV_randombytes() with C rand()
