...
{
  QRUOV_SEED seed_sk ; QRUOV_randombytes(seed_sk, QRUOV_SEED_LEN) ;
  QRUOV_SEED seed_pk ; QRUOV_randombytes(seed_pk, QRUOV_SEED_LEN) ;
            ...
            const unsigned char *sk)
{
  ...
  QRUOV_SEED seed_y       ; QRUOV_randombytes(seed_y  , QRUOV_SEED_LEN) ;
  QRUOV_SEED seed_r       ; QRUOV_randombytes(seed_r  , QRUOV_SEED_LEN) ;
  QRUOV_SEED seed_sol     ; QRUOV_randombytes(seed_sol, QRUOV_SEED_LEN) ;
