...
#define XKCP_DeclareSpongeFunctions(prefix) \
    ...
    XKCP_DeclareSpongeStructure(PERK_KeccakWidth1600, PERK_KeccakP1600_stateSizeInBytes, PERK_KeccakP1600_stateAlignment)
    XKCP_DeclareSpongeFunctions(PERK_KeccakWidth1600)
