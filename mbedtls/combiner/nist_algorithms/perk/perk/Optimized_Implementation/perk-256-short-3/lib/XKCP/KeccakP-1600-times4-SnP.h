...
#define PERK_KeccakP1600times4_implementation        "256-bit SIMD implementation (" PERK_KeccakP1600times4_implementation_config ")"
#define PERK_KeccakP1600times4_statesSizeInBytes     800
#define PERK_KeccakP1600times4_statesAlignment       32
#define PERK_KeccakF1600times4_FastLoop_supported
#define PERK_KeccakP1600times4_12rounds_FastLoop_supported
#define PERK_KeccakF1600times4_FastKravatte_supported

#include <stddef.h>

#define PERK_KeccakP1600times4_StaticInitialize()
void PERK_KeccakP1600times4_InitializeAll(void *states);
#define PERK_KeccakP1600times4_AddByte(states, instanceIndex, byte, offset) \
