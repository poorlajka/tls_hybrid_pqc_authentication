...
#define PRNG_BLOCK_SIZE 168  // PERK_SHAKE128 Block Size
#elif (SECURITY_BYTES == 24)
#define PRNG_BLOCK_SIZE 136  // PERK_SHAKE256 Block Size
#elif (SECURITY_BYTES == 32)
#define PRNG_BLOCK_SIZE 136  // PERK_SHAKE256 Block Size
#endif

typedef PERK_Keccak_HashInstance sig_perk_prg_state_t;
typedef PERK_Keccak_HashInstance sig_perk_hash_state_t;
