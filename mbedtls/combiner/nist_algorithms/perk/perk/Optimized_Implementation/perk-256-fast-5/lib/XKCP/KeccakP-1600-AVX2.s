...
#
# Notes:
# The code for the permutation (__PERK_KeccakF1600) was generated with
...
#
.globl  PERK_KeccakP1600_Initialize
.globl _PERK_KeccakP1600_Initialize
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_Initialize,@function
.endif
.endif
PERK_KeccakP1600_Initialize:
_PERK_KeccakP1600_Initialize:
.balign 32
...
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_Initialize,.-PERK_KeccakP1600_Initialize
.endif
.endif
...
#                                %rdi                 %rsi               %rdx
#
.globl  PERK_KeccakP1600_AddByte
.globl _PERK_KeccakP1600_AddByte
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_AddByte,@function
.endif
.endif
PERK_KeccakP1600_AddByte:
_PERK_KeccakP1600_AddByte:
.balign 32
    mov         %rdx, %rax
    and         $7, %rax
    and         $0xFFFFFFF8, %edx
...
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_AddByte,.-PERK_KeccakP1600_AddByte
.endif
.endif
...
#                                %rdi                         %rsi               %rdx                 %rcx
#
.globl  PERK_KeccakP1600_AddBytes
.globl _PERK_KeccakP1600_AddBytes
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_AddBytes,@function
.endif
.endif
PERK_KeccakP1600_AddBytes:
_PERK_KeccakP1600_AddBytes:
.balign 32
    cmp         $0, %rcx
    jz          PERK_KeccakP1600_AddBytes_Exit
    mov         %rdx, %rax                              # rax offset in lane
    and         $0xFFFFFFF8, %edx                       # rdx pointer into state index mapper
    lea         mapState(%rip), %r9
    add         %r9, %rdx
    and         $7, %rax
    jz          PERK_KeccakP1600_AddBytes_LaneAlignedCheck
    ...
    add         $8, %rdx
    add         %rdi, %rax
PERK_KeccakP1600_AddBytes_NotAlignedLoop:
    mov         (%rsi), %r8b
    inc         %rsi
    xorb        %r8b, (%rax)
    inc         %rax
    dec         %r9
    jnz         PERK_KeccakP1600_AddBytes_NotAlignedLoop
    jmp         PERK_KeccakP1600_AddBytes_LaneAlignedCheck
PERK_KeccakP1600_AddBytes_LaneAlignedLoop:
    mov         (%rsi), %r8
    add         $8, %rsi
    mov         (%rdx), %rax
    add         $8, %rdx
    add         %rdi, %rax
    xor         %r8, (%rax)
PERK_KeccakP1600_AddBytes_LaneAlignedCheck:
    sub         $8, %rcx
    jnc         PERK_KeccakP1600_AddBytes_LaneAlignedLoop
PERK_KeccakP1600_AddBytes_LastIncompleteLane:
    add         $8, %rcx
    jz          PERK_KeccakP1600_AddBytes_Exit
    mov         (%rdx), %rax
    add         %rdi, %rax
PERK_KeccakP1600_AddBytes_LastIncompleteLaneLoop:
    mov         (%rsi), %r8b
    inc         %rsi
    xor         %r8b, (%rax)
    inc         %rax
    dec         %rcx
    jnz         PERK_KeccakP1600_AddBytes_LastIncompleteLaneLoop
PERK_KeccakP1600_AddBytes_Exit:
    ret
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_AddBytes,.-PERK_KeccakP1600_AddBytes
.endif
.endif
...
#                                       %rdi                        %rsi               %rdx                 %rcx
#
.globl  PERK_KeccakP1600_OverwriteBytes
.globl _PERK_KeccakP1600_OverwriteBytes
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_OverwriteBytes,@function
.endif
.endif
PERK_KeccakP1600_OverwriteBytes:
_PERK_KeccakP1600_OverwriteBytes:
.balign 32
    cmp         $0, %rcx
    jz          PERK_KeccakP1600_OverwriteBytes_Exit
    mov         %rdx, %rax                              # rax offset in lane
    and         $0xFFFFFFF8, %edx                       # rdx pointer into state index mapper
    lea         mapState(%rip), %r9
    add         %r9, %rdx
    and         $7, %rax
    jz          PERK_KeccakP1600_OverwriteBytes_LaneAlignedCheck
    mov         $8, %r9                                 # r9 is (max) length of incomplete lane
    sub         %rax, %r9
    cmp         %rcx, %r9
    cmovae      %rcx, %r9
    ...
    add         $8, %rdx
    add         %rdi, %rax
PERK_KeccakP1600_OverwriteBytes_NotAlignedLoop:
    mov         (%rsi), %r8b
    inc         %rsi
    mov         %r8b, (%rax)
    inc         %rax
    dec         %r9
    jnz         PERK_KeccakP1600_OverwriteBytes_NotAlignedLoop
    jmp         PERK_KeccakP1600_OverwriteBytes_LaneAlignedCheck
PERK_KeccakP1600_OverwriteBytes_LaneAlignedLoop:
    mov         (%rsi), %r8
    add         $8, %rsi
    mov         (%rdx), %rax
    add         $8, %rdx
    add         %rdi, %rax
    mov         %r8, (%rax)
PERK_KeccakP1600_OverwriteBytes_LaneAlignedCheck:
    sub         $8, %rcx
    jnc         PERK_KeccakP1600_OverwriteBytes_LaneAlignedLoop
PERK_KeccakP1600_OverwriteBytes_LastIncompleteLane:
    add         $8, %rcx
    jz          PERK_KeccakP1600_OverwriteBytes_Exit
    mov         (%rdx), %rax
    add         %rdi, %rax
PERK_KeccakP1600_OverwriteBytes_LastIncompleteLaneLoop:
    mov         (%rsi), %r8b
    inc         %rsi
    mov         %r8b, (%rax)
    inc         %rax
    dec         %rcx
    jnz         PERK_KeccakP1600_OverwriteBytes_LastIncompleteLaneLoop
PERK_KeccakP1600_OverwriteBytes_Exit:
    ret
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_OverwriteBytes,.-PERK_KeccakP1600_OverwriteBytes
.endif
.endif
...
#                                            %rdi                %rsi
#
.globl  PERK_KeccakP1600_OverwriteWithZeroes
.globl _PERK_KeccakP1600_OverwriteWithZeroes
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_OverwriteWithZeroes,@function
.endif
.endif
PERK_KeccakP1600_OverwriteWithZeroes:
_PERK_KeccakP1600_OverwriteWithZeroes:
.balign 32
    cmp         $0, %rsi
    jz          PERK_KeccakP1600_OverwriteWithZeroes_Exit
    lea         mapState(%rip), %rdx                          # rdx pointer into state index mapper
    jmp         PERK_KeccakP1600_OverwriteWithZeroes_LaneAlignedCheck
PERK_KeccakP1600_OverwriteWithZeroes_LaneAlignedLoop:
    mov         (%rdx), %rax
    add         $8, %rdx
    add         %rdi, %rax
    movq        $0, (%rax)
PERK_KeccakP1600_OverwriteWithZeroes_LaneAlignedCheck:
    sub         $8, %rsi
    jnc         PERK_KeccakP1600_OverwriteWithZeroes_LaneAlignedLoop
PERK_KeccakP1600_OverwriteWithZeroes_LastIncompleteLane:
    add         $8, %rsi
    jz          PERK_KeccakP1600_OverwriteWithZeroes_Exit
    mov         (%rdx), %rax
    add         %rdi, %rax
PERK_KeccakP1600_OverwriteWithZeroes_LastIncompleteLaneLoop:
    movb        $0, (%rax)
    inc         %rax
    dec         %rsi
    jnz         PERK_KeccakP1600_OverwriteWithZeroes_LastIncompleteLaneLoop
PERK_KeccakP1600_OverwriteWithZeroes_Exit:
    ret
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_OverwriteWithZeroes,.-PERK_KeccakP1600_OverwriteWithZeroes
.endif
.endif
...
#                                           %rdi                  %rsi               %rdx                 %rcx
#
.globl  PERK_KeccakP1600_ExtractBytes
.globl _PERK_KeccakP1600_ExtractBytes
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_ExtractBytes,@function
.endif
.endif
PERK_KeccakP1600_ExtractBytes:
_PERK_KeccakP1600_ExtractBytes:
.balign 32
    push        %rbx
    cmp         $0, %rcx
    jz          PERK_KeccakP1600_ExtractBytes_Exit
    mov         %rdx, %rax                              # rax offset in lane
    and         $0xFFFFFFF8, %edx                       # rdx pointer into state index mapper
    lea         mapState(%rip), %r9
    add         %r9, %rdx
    and         $7, %rax
    jz          PERK_KeccakP1600_ExtractBytes_LaneAlignedCheck
    ...
    add         %rdi, %r9
    add         %rax, %r9
PERK_KeccakP1600_ExtractBytes_NotAlignedLoop:
    mov         (%r9), %r8b
    inc         %r9
    mov         %r8b, (%rsi)
    inc         %rsi
    dec         %rbx
    jnz         PERK_KeccakP1600_ExtractBytes_NotAlignedLoop
    jmp         PERK_KeccakP1600_ExtractBytes_LaneAlignedCheck
PERK_KeccakP1600_ExtractBytes_LaneAlignedLoop:
    mov         (%rdx), %rax
    add         $8, %rdx
    add         %rdi, %rax
    mov         (%rax), %r8
    mov         %r8, (%rsi)
    add         $8, %rsi
PERK_KeccakP1600_ExtractBytes_LaneAlignedCheck:
    sub         $8, %rcx
    jnc         PERK_KeccakP1600_ExtractBytes_LaneAlignedLoop
PERK_KeccakP1600_ExtractBytes_LastIncompleteLane:
    add         $8, %rcx
    jz          PERK_KeccakP1600_ExtractBytes_Exit
    mov         (%rdx), %rax
    add         %rdi, %rax
    mov         (%rax), %r8
PERK_KeccakP1600_ExtractBytes_LastIncompleteLaneLoop:
    mov         %r8b, (%rsi)
    shr         $8, %r8
    inc         %rsi
    dec         %rcx
    jnz         PERK_KeccakP1600_ExtractBytes_LastIncompleteLaneLoop
PERK_KeccakP1600_ExtractBytes_Exit:
    pop         %rbx
    ret
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_ExtractBytes,.-PERK_KeccakP1600_ExtractBytes
.endif
.endif
...
#                                                 %rdi                        %rsi                  %rdx                 %rcx                  %r8
#
.globl  PERK_KeccakP1600_ExtractAndAddBytes
.globl _PERK_KeccakP1600_ExtractAndAddBytes
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_ExtractAndAddBytes,@function
.endif
.endif
PERK_KeccakP1600_ExtractAndAddBytes:
_PERK_KeccakP1600_ExtractAndAddBytes:
.balign 32
    push        %rbx
    push        %r10
    cmp         $0, %r8
    jz          PERK_KeccakP1600_ExtractAndAddBytes_Exit
    mov         %rcx, %rax                              # rax offset in lane
    and         $0xFFFFFFF8, %ecx                       # rcx pointer into state index mapper
    lea         mapState(%rip), %r9
    add         %r9, %rcx
    and         $7, %rax
    jz          PERK_KeccakP1600_ExtractAndAddBytes_LaneAlignedCheck
    mov         $8, %rbx                                # rbx is (max) length of incomplete lane
    sub         %rax, %rbx
    cmp         %r8, %rbx
    cmovae      %r8, %rbx
    ...
    add         %rdi, %r9
    add         %rax, %r9
PERK_KeccakP1600_ExtractAndAddBytes_NotAlignedLoop:
    mov         (%r9), %r10b
    inc         %r9
    xor         (%rsi), %r10b
    inc         %rsi
    ...
    inc         %rdx
    dec         %rbx
    jnz         PERK_KeccakP1600_ExtractAndAddBytes_NotAlignedLoop
    jmp         PERK_KeccakP1600_ExtractAndAddBytes_LaneAlignedCheck
PERK_KeccakP1600_ExtractAndAddBytes_LaneAlignedLoop:
    mov         (%rcx), %rax
    add         $8, %rcx
    add         %rdi, %rax
    mov         (%rax), %r10
    ...
    mov         %r10, (%rdx)
    add         $8, %rdx
PERK_KeccakP1600_ExtractAndAddBytes_LaneAlignedCheck:
    sub         $8, %r8
    jnc         PERK_KeccakP1600_ExtractAndAddBytes_LaneAlignedLoop
PERK_KeccakP1600_ExtractAndAddBytes_LastIncompleteLane:
    add         $8, %r8
    jz          PERK_KeccakP1600_ExtractAndAddBytes_Exit
    mov         (%rcx), %rax
    add         %rdi, %rax
    mov         (%rax), %r10
PERK_KeccakP1600_ExtractAndAddBytes_LastIncompleteLaneLoop:
    xor         (%rsi), %r10b
    inc         %rsi
    mov         %r10b, (%rdx)
    inc         %rdx
    shr         $8, %r10
    dec         %r8
    jnz         PERK_KeccakP1600_ExtractAndAddBytes_LastIncompleteLaneLoop
PERK_KeccakP1600_ExtractAndAddBytes_Exit:
    pop         %r10
    pop         %rbx
    ret
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_ExtractAndAddBytes,.-PERK_KeccakP1600_ExtractAndAddBytes
.endif
.endif
...
.ifndef old_gas_syntax
.ifndef no_type
.type    __PERK_KeccakF1600,@function
.endif
.endif
.balign 32
__PERK_KeccakF1600:
...
.ifndef old_gas_syntax
.ifndef no_size
.size   __PERK_KeccakF1600,.-__PERK_KeccakF1600
.endif
.endif
...
#                                        %rdi
#
.globl  PERK_KeccakP1600_Permute_24rounds
.globl _PERK_KeccakP1600_Permute_24rounds
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_Permute_24rounds,@function
.endif
.endif
PERK_KeccakP1600_Permute_24rounds:
_PERK_KeccakP1600_Permute_24rounds:
.balign 32
...
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_Permute_24rounds,.-PERK_KeccakP1600_Permute_24rounds
.endif
.endif
...
#                                        %rdi
#
.globl  PERK_KeccakP1600_Permute_12rounds
.globl _PERK_KeccakP1600_Permute_12rounds
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_Permute_12rounds,@function
.endif
.endif
PERK_KeccakP1600_Permute_12rounds:
_PERK_KeccakP1600_Permute_12rounds:
.balign 32
    lea             rhotates_left+96(%rip),%r8
    lea             rhotates_right+96(%rip),%r9
...
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_Permute_12rounds,.-PERK_KeccakP1600_Permute_12rounds
.endif
.endif
...
#                                        %rdi                %rsi
#
.globl  PERK_KeccakP1600_Permute_Nrounds
.globl _PERK_KeccakP1600_Permute_Nrounds
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_Permute_Nrounds,@function
.endif
.endif
PERK_KeccakP1600_Permute_Nrounds:
_PERK_KeccakP1600_Permute_Nrounds:
.balign 32
    lea             rhotates_left+96(%rip),%r8
    lea             rhotates_right+96(%rip),%r9
...
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_Permute_Nrounds,.-PERK_KeccakP1600_Permute_Nrounds
.endif
.endif
...
#                                          %rdi                %rsi                            %rdx         %rcx
#
.globl  PERK_KeccakF1600_FastLoop_Absorb
.globl _PERK_KeccakF1600_FastLoop_Absorb
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakF1600_FastLoop_Absorb,@function
.endif
.endif
PERK_KeccakF1600_FastLoop_Absorb:
_PERK_KeccakF1600_FastLoop_Absorb:
.balign 32
    push            %rbx
    push            %r10
    ...
    cmp             %rsi, %rcx
    jb              PERK_KeccakF1600_FastLoop_Absorb_Exit
    vzeroupper
    cmp             $21, %rsi    
    jnz             PERK_KeccakF1600_FastLoop_Absorb_Not21Lanes
    sub             $21, %rcx
    lea             rhotates_left+96(%rip),%r8
    lea             rhotates_right+96(%rip),%r9
    lea             96(%rdi),%rdi
    ...
    vmovdqu         8+32*4-96(%rdi),%ymm5
    vmovdqu         8+32*5-96(%rdi),%ymm6
PERK_KeccakF1600_FastLoop_Absorb_Loop21Lanes:    
    ...
    call            __PERK_KeccakF1600
    sub             $21, %rcx
    jnc             PERK_KeccakF1600_FastLoop_Absorb_Loop21Lanes
PERK_KeccakF1600_FastLoop_Absorb_SaveAndExit:
    vmovq           %xmm0,-96(%rdi)
    vmovdqu         %ymm1,8+32*0-96(%rdi)
    vmovdqu         %ymm2,8+32*1-96(%rdi)
    vmovdqu         %ymm3,8+32*2-96(%rdi)
    ...
    vmovdqu         %ymm5,8+32*4-96(%rdi)
    vmovdqu         %ymm6,8+32*5-96(%rdi)
PERK_KeccakF1600_FastLoop_Absorb_Exit:
    vzeroupper
    ...
    pop             %rbx
    ret
PERK_KeccakF1600_FastLoop_Absorb_Not21Lanes:
    cmp             $17, %rsi    
    jnz             PERK_KeccakF1600_FastLoop_Absorb_Not17Lanes
    sub             $17, %rcx
    lea             rhotates_left+96(%rip),%r8
    lea             rhotates_right+96(%rip),%r9
    lea             96(%rdi),%rdi
    ...
    vmovdqu         8+32*4-96(%rdi),%ymm5
    vmovdqu         8+32*5-96(%rdi),%ymm6
PERK_KeccakF1600_FastLoop_Absorb_Loop17Lanes:    
    vpbroadcastq    (%rdx),%ymm7
    vmovdqu         8(%rdx),%ymm8
    ...
    call            __PERK_KeccakF1600
    sub             $17, %rcx
    jnc             PERK_KeccakF1600_FastLoop_Absorb_Loop17Lanes
    jmp             PERK_KeccakF1600_FastLoop_Absorb_SaveAndExit
PERK_KeccakF1600_FastLoop_Absorb_Not17Lanes:
    lea             mapState(%rip), %r9
    mov             %rsi, %rax
PERK_KeccakF1600_FastLoop_Absorb_LanesAddLoop:
    mov             (%rdx), %r8
    add             $8, %rdx
    mov             (%r9), %r10
    add             $8, %r9
    ...
    xor             %r8, (%r10)
    sub             $1, %rax
    jnz             PERK_KeccakF1600_FastLoop_Absorb_LanesAddLoop
    sub             %rsi, %rcx
    push            %rdi
    push            %rsi
    push            %rdx
    push            %rcx
.ifdef no_plt
    call            PERK_KeccakP1600_Permute_24rounds
.else
    call            PERK_KeccakP1600_Permute_24rounds@PLT
.endif
    pop             %rcx
    pop             %rdx
    pop             %rsi
    pop             %rdi
    cmp             %rsi, %rcx
    jae             PERK_KeccakF1600_FastLoop_Absorb_Not17Lanes
    jmp             PERK_KeccakF1600_FastLoop_Absorb_Exit
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakF1600_FastLoop_Absorb,.-PERK_KeccakF1600_FastLoop_Absorb
.endif
.endif
...
#                                          %rdi                %rsi                            %rdx         %rcx
#
.globl  PERK_KeccakP1600_12rounds_FastLoop_Absorb
.globl _PERK_KeccakP1600_12rounds_FastLoop_Absorb
.ifndef old_gas_syntax
.ifndef no_type
.type   PERK_KeccakP1600_12rounds_FastLoop_Absorb,@function
.endif
.endif
PERK_KeccakP1600_12rounds_FastLoop_Absorb:
_PERK_KeccakP1600_12rounds_FastLoop_Absorb:
.balign 32
    push            %rbx
    push            %r10
    shr             $3, %rcx                # rcx = data length in lanes
    mov             %rdx, %rbx              # rbx = initial data pointer
    cmp             %rsi, %rcx
    jb              PERK_KeccakP1600_12rounds_FastLoop_Absorb_Exit
    vzeroupper
    cmp             $21, %rsi    
    jnz             PERK_KeccakP1600_12rounds_FastLoop_Absorb_Not21Lanes
    sub             $21, %rcx
    lea             rhotates_left+96(%rip),%r8
    lea             rhotates_right+96(%rip),%r9
    lea             96(%rdi),%rdi
    ...
    vmovdqu         8+32*4-96(%rdi),%ymm5
    vmovdqu         8+32*5-96(%rdi),%ymm6
PERK_KeccakP1600_12rounds_FastLoop_Absorb_Loop21Lanes:    
    vpbroadcastq    (%rdx),%ymm7
    vmovdqu         8(%rdx),%ymm8
    ...
    call            __PERK_KeccakF1600
    sub             $21, %rcx
    jnc             PERK_KeccakP1600_12rounds_FastLoop_Absorb_Loop21Lanes
PERK_KeccakP1600_12rounds_FastLoop_Absorb_SaveAndExit:
    vmovq           %xmm0,-96(%rdi)
    vmovdqu         %ymm1,8+32*0-96(%rdi)
    vmovdqu         %ymm2,8+32*1-96(%rdi)
    vmovdqu         %ymm3,8+32*2-96(%rdi)
    ...
    vmovdqu         %ymm5,8+32*4-96(%rdi)
    vmovdqu         %ymm6,8+32*5-96(%rdi)
PERK_KeccakP1600_12rounds_FastLoop_Absorb_Exit:
    vzeroupper
    mov             %rdx, %rax               # return number of bytes processed
    sub             %rbx, %rax
    pop             %r10
    pop             %rbx
    ret
PERK_KeccakP1600_12rounds_FastLoop_Absorb_Not21Lanes:
    cmp             $17, %rsi    
    jnz             PERK_KeccakP1600_12rounds_FastLoop_Absorb_Not17Lanes
    sub             $17, %rcx
    lea             rhotates_left+96(%rip),%r8
    lea             rhotates_right+96(%rip),%r9
    lea             96(%rdi),%rdi
    ...
    vmovdqu         8+32*4-96(%rdi),%ymm5
    vmovdqu         8+32*5-96(%rdi),%ymm6
PERK_KeccakP1600_12rounds_FastLoop_Absorb_Loop17Lanes:    
    vpbroadcastq    (%rdx),%ymm7
    vmovdqu         8(%rdx),%ymm8
    ...
    call            __PERK_KeccakF1600
    sub             $17, %rcx
    jnc             PERK_KeccakP1600_12rounds_FastLoop_Absorb_Loop17Lanes
    jmp             PERK_KeccakP1600_12rounds_FastLoop_Absorb_SaveAndExit
PERK_KeccakP1600_12rounds_FastLoop_Absorb_Not17Lanes:
    lea             mapState(%rip), %r9
    mov             %rsi, %rax
PERK_KeccakP1600_12rounds_FastLoop_Absorb_LanesAddLoop:
    mov             (%rdx), %r8
    add             $8, %rdx
    mov             (%r9), %r10
    add             $8, %r9
    ...
    xor             %r8, (%r10)
    sub             $1, %rax
    jnz             PERK_KeccakP1600_12rounds_FastLoop_Absorb_LanesAddLoop
    sub             %rsi, %rcx
    push            %rdi
    push            %rsi
    push            %rdx
    push            %rcx
.ifdef no_plt
    call            PERK_KeccakP1600_Permute_12rounds
.else
    call            PERK_KeccakP1600_Permute_12rounds@PLT
.endif
    pop             %rcx
    pop             %rdx
    pop             %rsi
    pop             %rdi
    cmp             %rsi, %rcx
    jae             PERK_KeccakP1600_12rounds_FastLoop_Absorb_Not17Lanes
    jmp             PERK_KeccakP1600_12rounds_FastLoop_Absorb_Exit
.ifndef old_gas_syntax
.ifndef no_size
.size   PERK_KeccakP1600_12rounds_FastLoop_Absorb,.-PERK_KeccakP1600_12rounds_FastLoop_Absorb
.endif
.endif
