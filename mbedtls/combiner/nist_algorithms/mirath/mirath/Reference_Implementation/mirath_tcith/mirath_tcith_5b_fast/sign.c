 ...
 */
int MIRATH_crypto_sign(unsigned char *sig_msg, unsigned long long *smlen, const unsigned char *msg, unsigned long long mlen, const unsigned char *sk) {
 ...
 */
int MIRATH_crypto_sign_open(unsigned char *msg, unsigned long long *mlen, const unsigned char *sig_msg, unsigned long long smlen, const unsigned char *pk) {
