...
/* Nothing to do: 'MIRATH_randombytes' is defined by SUPERCOP. */
...
void MIRATH_randombytes(uint8_t *target, size_t length)
{
...
#error "MIRATH_randombytes on Windows not implemented yet!"
#endif
