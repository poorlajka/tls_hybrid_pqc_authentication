                                ...
                                mbedtls_pk_restart_ctx *rs_ctx)
{
    ...
    /*
        We get here for the test example btw :)
        VIKTOR UGLY STUFF
                        ...
                        void *p_rng)
{
    ...
    /*
        VIKTOR UGLY STUFF
        This is supposed to check if we're using RSASSA-PSS signature
        which I don't want to so I'm going to just force it by setting it to none 
        which is supper ugly but I don't care for now.
    */
