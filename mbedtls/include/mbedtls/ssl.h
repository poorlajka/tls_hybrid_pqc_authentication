...
#define MBEDTLS_SSL_SIG_PQC_HYBRID                7
...
/* Viktor hybrid algorithm*/
#define MBEDTLS_TLS1_3_SIG_PQC_HYBRID_SHA256 0x0407
...
struct mbedtls_ssl_context {
    /*
        ADDED UGLY STUFF BY VIKTOR HERE
    */
    hybrid_t hybrid;
...
/**
 * \brief               Return the name o the ciphersuite associated with the
 *                      given ID
 *
