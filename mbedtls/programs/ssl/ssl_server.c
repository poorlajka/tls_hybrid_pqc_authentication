...
#define HTTP_RESPONSE \
    ...
    "<h2 style=\"color: red;\">Mbed TLS PQC Hybrid Test Server</h2>\r\n" \
    "<p>Successful connection using: %s</p>\r\n"\
    "<ul>"\
        "<li>hybrid len: %zu</li>"\
        "<li>combiner type: %s</li>"\
        "<li>schemes: %s</li>"\
    "</ul>\r\n"
...
int main(void)
{
    ...
    ret = mbedtls_x509_crt_parse_file(&srvcert, "hybrid_crt.crt");
    if (ret != 0) {
...
reset:
    ...
    len = sprintf((char *) buf, HTTP_RESPONSE,
                  mbedtls_ssl_get_ciphersuite(&ssl), hybrid.len, comb_to_str(hybrid.combiner), schemes_to_str(&hybrid));
